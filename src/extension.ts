...
export function activate(context: vscode.ExtensionContext) {
  ...
  vscode.commands.registerCommand(
    'OnelintConsoleLog.displayLogMessage',
    async () => {
      ...
      const config: vscode.WorkspaceConfiguration =
        vscode.workspace.getConfiguration('OnelintConsoleLog')
  ...
  vscode.commands.registerCommand(
    'OnelintConsoleLog.displayErrorMessage',
    async () => {
      const editor: vscode.TextEditor | undefined =
        vscode.window.activeTextEditor
      if (!editor) {
  ...
  vscode.commands.registerCommand(
    'OnelintConsoleLog.displayTableLogMessage',
    async () => {
      const editor: vscode.TextEditor | undefined =
        vscode.window.activeTextEditor
      if (!editor) {
  ...
  vscode.commands.registerCommand(
    'OnelintConsoleLog.commentAllLogMessages',
    () => {
      const editor: vscode.TextEditor | undefined =
        vscode.window.activeTextEditor
      if (!editor) {
  ...
  vscode.commands.registerCommand(
    'OnelintConsoleLog.uncommentAllLogMessages',
    () => {
      const editor: vscode.TextEditor | undefined =
        vscode.window.activeTextEditor
      if (!editor) {
  ...
  vscode.commands.registerCommand(
    'OnelintConsoleLog.deleteAllLogMessages',
    () => {
      const editor: vscode.TextEditor | undefined =
        vscode.window.activeTextEditor
      if (!editor) {
